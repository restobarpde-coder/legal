...
export function MessageSettings() {
  ...
  const [form, setForm] = useState({ account_type: 'personal', user_id: '', email_address: '', display_name: '', imap_host: 'imap.hostinger.com', imap_port: '993', smtp_host: 'smtp.hostinger.com', smtp_port: '587', username: '', password: '' })
  ...
  async function createAccount(event: FormEvent) {
    ...
    const body = { ...form, user_id: form.account_type === 'personal' ? form.user_id : null, imap_port: Number(form.imap_port), smtp_port: Number(form.smtp_port), imap_tls: true, smtp_tls: true }
